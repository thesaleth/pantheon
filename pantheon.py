...
print(Col.orange+center("   Pantheon - Le plus rapide téléchargeur de video Youtube.")+Col.white)

print("\n\n")

video_url = input(Col.yellow+"URL de la Video > "+Col.white)
...
if not video_title:
    input(Col.red+"URL Invalide!"+Col.white)
    exit()

else:
    print(Col.orange+"Titre de la Video: "+Col.white+video_title)
...
print(Col.orange+"Entrain d'obtenir le lien de téléchargement...\n"+Col.white)
